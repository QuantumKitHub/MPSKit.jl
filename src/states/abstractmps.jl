...
left_virtualspace(ψ) = map(Base.Fix1(left_virtualspace, ψ), eachsite(ψ))
...
right_virtualspace(ψ) = map(Base.Fix1(right_virtualspace, ψ), eachsite(ψ))
...
physicalspace(ψ) = map(Base.Fix1(physicalspace, ψ), eachsite(ψ))
