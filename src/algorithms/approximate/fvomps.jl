...
function approximate!(init::AbstractFiniteMPS,squash::Vector,alg::DMRG2,envs=[environments(init,sq) for sq in squash])
...
function approximate!(init::AbstractFiniteMPS, squash::Vector,alg::DMRG,envs = [environments(init,sq) for sq in squash])
