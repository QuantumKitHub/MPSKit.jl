...
plot(real.(energies); seriestype=:scatter, legend=false, ylabel="energy",
     xlabel="#eigenvalue")
...
plot(momenta, real.(energies[1:18]); seriestype=:scatter, xlabel="momentum",
     ylabel="energy", legend=false)
...
plot(momenta_mps, real.(energies[1:16]); seriestype=:scatter, xlabel="momentum",
     ylabel="energy", legend=false)
