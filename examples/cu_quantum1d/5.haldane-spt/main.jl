...
H = adapt(CuArray, heisenberg_hamiltonian())
...
ψ = adapt(CuArray, InfiniteMPS(ℋ, V_wrong))
...
ψ_plus = adapt(CuArray, InfiniteMPS(ℋ, V_plus))
...
ψ_minus = adapt(CuArray, InfiniteMPS(ℋ, V_minus))
